...
const MARKER_ICONS = {
    ...
    zombified_cluster: L.icon({ iconUrl: 'markers/NPC/npc_outpost.png', iconSize: [24, 24], iconAnchor: [12, 12], popupAnchor: [0, -12] }),
    bandits: L.icon({ iconUrl: 'markers/NPC/Bandits.png', iconSize: [28, 28], iconAnchor: [14, 14], popupAnchor: [0, -14] }),
    bandit_camp: L.icon({ iconUrl: 'markers/NPC/npc_outpost.png', iconSize: [24, 24], iconAnchor: [12, 12], popupAnchor: [0, -12] }),
    military: L.icon({ iconUrl: 'markers/NPC/military.png', iconSize: [28, 28], iconAnchor: [14, 14], popupAnchor: [0, -14] }),
    monolith_outpost: L.icon({ iconUrl: 'markers/NPC/npc_outpost.png', iconSize: [24, 24], iconAnchor: [12, 12], popupAnchor: [0, -12] }),
