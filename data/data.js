...
const ARMORS = [
    ...
    },
    {
        ...
        stats: { radiationProtection: 200, bioProtection: 200, thermalProtection: 100, psiProtection: 100, heatResistance: 42, chemResistance: 42, electroResistance: 42, impactResistance: 258, tearProtection: 356, bulletResistance: 400, maxStamina: -10.00, moveSpeed: -8.00, maxWeight: 60.00 },
...
const ARTIFACTS = [
    ...
    { id: 'yantarnik', name: 'Янтарник', nameEn: 'Yantarnik', category: 'gravity', tier: 3, image: 'yantarnik.png', imageFolder: 'Artifacts', price: 52000, stats: { impactResistance: 90, maxWeight: 18.00, bulletResistance: 24, radiation: 3.00 } },
    ...
    { id: 'dark_medusa', name: 'Тёмная медуза', nameEn: 'Dark Medusa', category: 'gravity', tier: 3, image: 'dark_medusa.png', imageFolder: 'Artifacts', price: 78000, stats: { impactResistance: 159, bulletResistance: 42, staminaRegen: -1.50, maxStamina: -15.00, radiation: 5.00 } },
    ...
    { id: 'thorn', name: 'Колючка', nameEn: 'Thorn', category: 'chemical', tier: 1, image: 'thorn.png', imageFolder: 'Artifacts', price: 10300, stats: { radiationProtection: 30, radiation: -3.00, bleeding: 1.50 } },
    ...
    { id: 'crystal_thorn', name: 'Кристальная колючка', nameEn: 'Crystal Thorn', category: 'chemical', tier: 2, image: 'crystal_thorn.png', imageFolder: 'Artifacts', price: 31000, stats: { radiationProtection: 40, radiation: -4.00, bleeding: 2.00 } },
    { id: 'firefly', name: 'Светляк', nameEn: 'Firefly', category: 'chemical', tier: 3, image: 'firefly.png', imageFolder: 'Artifacts', price: 42000, stats: { staminaRegen: 2.00, bleeding: -3.00, regeneration: 5.50, moveSpeed: 1.50, saturation: -1.75, radiation: 4.00 } },
    { id: 'mica', name: 'Слюда', nameEn: 'Mica', category: 'chemical', tier: 3, image: 'mica.png', imageFolder: 'Artifacts', price: 45000, stats: { staminaRegen: 2.00, bleeding: -5.00, maxWeight: 6.50, maxStamina: 20.00, chemResistance: -20 } },
    { id: 'pellicle', name: 'Плёнка', nameEn: 'Pellicle', category: 'chemical', tier: 3, image: 'pellicle.png', imageFolder: 'Artifacts', price: 47000, stats: { bioProtection: 50, saturation: 2.50, radiation: 2.00 } },
    ...
    { id: 'kolobok', name: 'Колобок', nameEn: 'Kolobok', category: 'chemical', tier: 3, image: 'kolobok.png', imageFolder: 'Artifacts', price: 78000, stats: { bleeding: -4.00, regeneration: 3.00, bulletResistance: -8, radiation: 2.00 } },
    ...
    { id: 'battery', name: 'Батарейка', nameEn: 'Battery', category: 'electric', tier: 1, image: 'battery.png', imageFolder: 'Artifacts', price: 15000, stats: { staminaRegen: 1.50, moveSpeed: 1.00, maxStamina: 15.00, radiation: 1.00 } },
    ...
    { id: 'sky_stone', name: 'Небесный камень', nameEn: 'Sky Stone', category: 'electric', tier: 2, image: 'sky_stone.png', imageFolder: 'Artifacts', price: 22000, stats: { staminaRegen: 2.25, regeneration: 2.00, moveSpeed: 1.75, electroResistance: 25, saturation: -0.35, radiation: 2.50 } },
    ...
    { id: 'dummy', name: 'Пустышка', nameEn: 'Dummy', category: 'electric', tier: 3, image: 'dummy.png', imageFolder: 'Artifacts', price: 35000, stats: { staminaRegen: 5.25, moveSpeed: 2.50, maxStamina: -20.00, radiation: 4.00 } },
    { id: 'halogen', name: 'Галоген', nameEn: 'Halogen', category: 'electric', tier: 3, image: 'halogen.png', imageFolder: 'Artifacts', price: 61000, stats: { psiProtection: 120, maxStamina: 10.00, moveSpeed: 3.50, bleeding: 5.00 } },
    ...
    { id: 'fire_loop', name: 'Огненная петля', nameEn: 'Fire Loop', category: 'thermal', tier: 3, image: 'fire_loop.png', imageFolder: 'Artifacts', price: 36000, stats: { bleeding: -6.00, regeneration: 4.75, maxStamina: -10.00, saturation: -1.25, radiation: 3.50 } },
    ...
    { id: 'medallion', name: 'Медальон', nameEn: 'Medallion', category: 'unique', tier: 3, image: 'medallion.png', imageFolder: 'Artifacts', price: null, priceText: 'Нельзя продать', priceTextEn: 'Cannot sell', stats: { bleeding: -3.00, maxWeight: 10.00, regeneration: 2.00 } },
    ...
    { id: 'polar_star', name: 'Полярная звезда', nameEn: 'Polar Star', category: 'frost', tier: 2, image: 'polar_star.png', imageFolder: 'Artifacts', price: null, priceText: 'Ивент', priceTextEn: 'Event', stats: { staminaRegen: 1.00, frostProtection: 100, maxStamina: 10.00, cold: -40.00, psiProtection: -25, radiation: 1.00 } },
    { id: 'purple_tear', name: 'Пурпурная слеза', nameEn: 'Purple Tear', category: 'frost', tier: 2, image: 'purple_tear.png', imageFolder: 'Artifacts', price: null, priceText: 'Ивент', priceTextEn: 'Event', stats: { staminaRegen: 3.00, thermalProtection: 30, bleeding: -4.00, maxStamina: 30.00, moveSpeed: 3.50, heatResistance: 20, frostProtection: -50, bulletResistance: -12, radiation: 2.00, cold: 20.00 } },
...
const WEAPONS = [
    ...
    { id: 'lr300', image: 'lr300.png', imageFolder: 'Weapons', name: 'LR-300', nameEn: 'LR-300', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 32, rpm: 930, headshotMult: 1.25, effectiveRange: 15, fireModes: ['auto', 'single'], damageFalloff: { end: 90, minScale: 0.58 }, ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], stats: { verticalRecoil: 1.2, horizontalRecoil: 0.22, hipSpread: 0.53, adsSpread: 0.19 } },
    { id: 'fn_fal', image: 'fn_fal.png', imageFolder: 'Weapons', name: 'FN FAL', nameEn: 'FN FAL', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 41, rpm: 650, headshotMult: 1.25, effectiveRange: 20, magazine: 20, fireModes: ['auto', 'single'], damageFalloff: { end: 90, minScale: 0.58 }, ammoTypes: ['762x51_m59', '762x51_m61', '762x51_exp'], stats: { verticalRecoil: 1.65, horizontalRecoil: 0.58, hipSpread: 0.72, adsSpread: 0.12 } },
    ...
    { id: 'ash12', image: 'ash12.png', imageFolder: 'Weapons', name: 'АШ-12', nameEn: 'ASh-12', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 46, rpm: 600, headshotMult: 1.25, effectiveRange: 12, magazine: 20, damageFalloff: { end: 95, minScale: 0.6 }, fireModes: ['auto', 'single'], ammoTypes: ['127x55', '127x55_exp'], stats: { verticalRecoil: 2.60, horizontalRecoil: 0.70, hipSpread: 1, adsSpread: 0.22 } },
    ...
    // SNIPER RIFLES
    { id: 'remington_700', image: 'remington_700.png', imageFolder: 'Weapons', name: 'Remington 700', nameEn: 'Remington 700', category: 'sniper', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 126, rpm: 30, headshotMult: 1.5, effectiveRange: 55, fireModes: ['single'], damageFalloff: { end: 264, minScale: 0.9 }, ammoTypes: ['308_winchester', '308_winchester_exp'], stats: { verticalRecoil: 3, horizontalRecoil: 2.15, hipSpread: 5, adsSpread: 0.08 } },
    { id: 'svd', image: 'svd.png', imageFolder: 'Weapons', name: 'Снайперская винтовка Драгунова', nameEn: 'SVD Dragunov', category: 'sniper', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 99, rpm: 111, headshotMult: 1.25, effectiveRange: 40, fireModes: ['single'], damageFalloff: { end: 196, minScale: 0.8 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 6, horizontalRecoil: 2, hipSpread: 5, adsSpread: 0.11 } },
    { id: 'vsk94', image: 'vsk94.png', imageFolder: 'Weapons', name: 'ВСК-94', nameEn: 'VSK-94', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 40, rpm: 700, headshotMult: 1.35, effectiveRange: 25, magazine: 20, damageFalloff: { end: 140, minScale: 0.7 }, fireModes: ['auto', 'single'], ammoTypes: ['9x39_sp5', '9x39_sp6', '9x39_exp'], stats: { verticalRecoil: 1, horizontalRecoil: 0.1, hipSpread: 2.5, adsSpread: 0.12 } },
    { id: 'sig_sg550_sniper', image: 'sig_sg550_sniper.png', imageFolder: 'Weapons', name: 'SIG SG 550 Sniper', nameEn: 'SIG SG 550 Sniper', category: 'sniper', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 33, rpm: 480, headshotMult: 1.35, effectiveRange: 36, magazine: 30, fireModes: ['auto', 'single'], damageFalloff: { end: 176, minScale: 0.8 }, ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], stats: { verticalRecoil: 1.20, horizontalRecoil: 0.35, hipSpread: 1.50, adsSpread: 0.06 } },
    { id: 'walther_wa2000', image: 'walther_wa2000.png', imageFolder: 'Weapons', name: 'Walther WA 2000', nameEn: 'Walther WA 2000', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 110, rpm: 120, headshotMult: 1.5, effectiveRange: 44, magazine: 6, fireModes: ['single'], damageFalloff: { end: 216, minScale: 0.8 }, ammoTypes: ['308_winchester', '308_winchester_exp'], stats: { verticalRecoil: 4.7, horizontalRecoil: 1.54, hipSpread: 5, adsSpread: 0.05, moveSpeed: -3.00 } },
    { id: 'sv98', image: 'sv98.png', imageFolder: 'Weapons', name: 'СВ-98', nameEn: 'SV-98', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 161, rpm: 33, headshotMult: 1.5, effectiveRange: 50, magazine: 5, fireModes: ['single'], damageFalloff: { end: 240, minScale: 0.9 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.55, horizontalRecoil: 3.1, hipSpread: 5, adsSpread: 0.05, moveSpeed: -3.00 } },
    { id: 'sako_trg42', image: 'sako_trg42.png', imageFolder: 'Weapons', name: 'Sako TRG-42', nameEn: 'Sako TRG-42', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 162, rpm: 30, headshotMult: 1.5, effectiveRange: 55, magazine: 5, fireModes: ['single'], damageFalloff: { end: 264, minScale: 0.9 }, ammoTypes: ['308_winchester', '308_winchester_exp'], stats: { verticalRecoil: 4, horizontalRecoil: 3.5, hipSpread: 5, adsSpread: 0.05, moveSpeed: -3.00 } },
    { id: 'barrett_m82', image: 'barrett_m82.png', imageFolder: 'Weapons', name: 'Barrett M82', nameEn: 'Barrett M82', category: 'sniper', rarity: 'legendary', rarityName: 'Легендарное', rarityNameEn: 'Legendary', damage: 155, rpm: 100, headshotMult: 1.35, effectiveRange: 48, fireModes: ['single'], damageFalloff: { end: 232, minScale: 0.8 }, ammoTypes: ['127x55', '127x55_exp'], stats: { verticalRecoil: 6.20, horizontalRecoil: 1.68, hipSpread: 10, adsSpread: 0.07, moveSpeed: -10.00 } },
    { id: 'm24', image: 'm24.png', imageFolder: 'Weapons', name: 'Снайперская винтовка М24', nameEn: 'M24 Sniper Rifle', category: 'sniper', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 141, rpm: 35, headshotMult: 1.5, effectiveRange: 55, magazine: 5, fireModes: ['single'], damageFalloff: { end: 264, minScale: 0.9 }, ammoTypes: ['308_winchester', '308_winchester_exp'], stats: { verticalRecoil: 2.75, horizontalRecoil: 1.8, hipSpread: 5, adsSpread: 0.05 } },
    { id: 'mosin_obrez', image: 'mosin_obrez.png', imageFolder: 'Weapons', name: 'Обрез винтовки Мосина', nameEn: 'Mosin Obrez', category: 'sniper', damage: 112, rpm: 20, headshotMult: 1.5, effectiveRange: 10, fireModes: ['single'], damageFalloff: { end: 81, minScale: 0.9 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.65, horizontalRecoil: 2.2, hipSpread: 2, adsSpread: 0.19 } },
    { id: 'mosin', image: 'mosin.png', imageFolder: 'Weapons', name: 'Винтовка Мосина', nameEn: 'Mosin Rifle', category: 'sniper', rarity: 'common', rarityName: 'Распространённое', rarityNameEn: 'Common', damage: 114, rpm: 20, headshotMult: 1.5, effectiveRange: 50, fireModes: ['single'], damageFalloff: { end: 240, minScale: 0.9 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.65, horizontalRecoil: 2.2, hipSpread: 2, adsSpread: 0.08 } },
    ...
    { id: 'l96a1', image: 'l96a1.png', imageFolder: 'Weapons', name: 'L96A1', nameEn: 'L96A1', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 158, rpm: 30, headshotMult: 1.5, effectiveRange: 55, magazine: 5, fireModes: ['single'], damageFalloff: { end: 264, minScale: 0.9 }, ammoTypes: ['308_winchester', '308_winchester_exp'], stats: { verticalRecoil: 2.1, horizontalRecoil: 1, hipSpread: 5, adsSpread: 0.03, moveSpeed: -3.00 } },
    { id: 'svu', image: 'svu.png', imageFolder: 'Weapons', name: 'Снайперская винтовка укороченная', nameEn: 'SVU', category: 'sniper', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 80, rpm: 133, headshotMult: 1.35, effectiveRange: 40, fireModes: ['single'], damageFalloff: { end: 196, minScale: 0.8 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3, horizontalRecoil: 1.5, hipSpread: 5, adsSpread: 0.1 } },
    { id: 'svds', image: 'svds.png', imageFolder: 'Weapons', name: 'СВД-С', nameEn: 'SVDS', category: 'sniper', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 100, rpm: 120, headshotMult: 1.35, effectiveRange: 40, fireModes: ['single'], damageFalloff: { end: 196, minScale: 0.8 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 5, horizontalRecoil: 1.4, hipSpread: 5, adsSpread: 0.09 } },
    { id: 'mk14_ebr', image: 'mk14_ebr.png', imageFolder: 'Weapons', name: 'Mk14 Enhanced Battle Rifle', nameEn: 'Mk14 EBR', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 50, rpm: 320, headshotMult: 1.35, effectiveRange: 40, magazine: 20, fireModes: ['auto', 'single'], damageFalloff: { end: 200, minScale: 0.8 }, ammoTypes: ['762x51_m59', '762x51_m61', '762x51_exp'], stats: { verticalRecoil: 1.50, horizontalRecoil: 0.25, hipSpread: 1.50, adsSpread: 0.05 } },
    { id: 'sr25', image: 'sr25.png', imageFolder: 'Weapons', name: 'SR-25', nameEn: 'SR-25', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 74, rpm: 215, headshotMult: 1.5, effectiveRange: 44, magazine: 20, fireModes: ['single'], damageFalloff: { end: 216, minScale: 0.8 }, ammoTypes: ['308_winchester', '308_winchester_exp'], stats: { verticalRecoil: 2.52, horizontalRecoil: 0.55, hipSpread: 5, adsSpread: 0.1 } },
    { id: 'sks', image: 'sks.png', imageFolder: 'Weapons', name: 'СКС', nameEn: 'SKS', category: 'sniper', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', damage: 40, rpm: 460, headshotMult: 1.35, effectiveRange: 34, fireModes: ['single'], damageFalloff: { end: 166, minScale: 0.8 }, ammoTypes: ['762x39_ps', '762x39_bp', '762x39_exp'], stats: { verticalRecoil: 3, horizontalRecoil: 1.5, hipSpread: 1.5, adsSpread: 0.17 } },
    { id: 'vssk_vykhlop', image: 'vssk_vykhlop.png', imageFolder: 'Weapons', name: 'ВССК «Выхлоп»', nameEn: 'VSSK "Vykhlop"', category: 'sniper', rarity: 'legendary', rarityName: 'Легендарное', rarityNameEn: 'Legendary', damage: 175, rpm: 27, headshotMult: 1.5, effectiveRange: 65, magazine: 5, damageFalloff: { end: 318, minScale: 1 }, fireModes: ['single'], ammoTypes: ['127x55', '127x55_exp'], stats: { verticalRecoil: 10, horizontalRecoil: 9.5, hipSpread: 5, adsSpread: 0.04, moveSpeed: -4.00 } },
    { id: 'svt40', image: 'svt40.png', imageFolder: 'Weapons', name: 'СВТ-40', nameEn: 'SVT-40', category: 'sniper', rarity: 'common', rarityName: 'Распространённое', rarityNameEn: 'Common', damage: 67, rpm: 120, headshotMult: 1.35, effectiveRange: 40, fireModes: ['single'], damageFalloff: { end: 196, minScale: 0.8 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.3, horizontalRecoil: 1.63, hipSpread: 5, adsSpread: 0.16 } },
    { id: 'avt40', image: 'avt40.png', imageFolder: 'Weapons', name: 'АВТ-40', nameEn: 'AVT-40', category: 'sniper', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', damage: 60, rpm: 230, headshotMult: 1.35, effectiveRange: 40, fireModes: ['auto', 'single'], damageFalloff: { end: 196, minScale: 0.8 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.2, horizontalRecoil: 1.63, hipSpread: 5, adsSpread: 0.19 } },
    ...
    { id: 'vss_vintorez', image: 'vss_vintorez.png', imageFolder: 'Weapons', name: 'ВСС «Винторез»', nameEn: 'VSS "Vintorez"', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 39, rpm: 700, headshotMult: 1.35, effectiveRange: 25, fireModes: ['auto', 'single'], damageFalloff: { end: 140, minScale: 0.7 }, ammoTypes: ['9x39_sp5', '9x39_sp6', '9x39_exp'], stats: { verticalRecoil: 1.05, horizontalRecoil: 0.1, hipSpread: 2.5, adsSpread: 0.12 } },
    { id: 'ots03_svua', image: 'ots03_svua.png', imageFolder: 'Weapons', name: 'ОЦ-03 СВУ-А', nameEn: 'OTs-03 SVU-A', category: 'sniper', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 57, rpm: 221, headshotMult: 1.35, effectiveRange: 40, fireModes: ['auto'], damageFalloff: { end: 196, minScale: 0.8 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 1.75, horizontalRecoil: 0.87, hipSpread: 5, adsSpread: 0.12 } },
    { id: 'hk_g3sg1', image: 'hk_g3sg1.png', imageFolder: 'Weapons', name: 'HK G3SG-1', nameEn: 'HK G3SG-1', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 50, rpm: 350, headshotMult: 1.35, effectiveRange: 35, magazine: 20, fireModes: ['auto', 'single'], damageFalloff: { end: 190, minScale: 0.8 }, ammoTypes: ['762x51_m59', '762x51_m61', '762x51_exp'], stats: { verticalRecoil: 1.33, horizontalRecoil: 0.25, hipSpread: 1.50, adsSpread: 0.07 } },
    { id: 'gauss_gun', image: 'gauss_gun.png', imageFolder: 'Weapons', name: 'Гаусс-пушка', nameEn: 'Gauss Gun', category: 'sniper', rarity: 'legendary', rarityName: 'Легендарное', rarityNameEn: 'Legendary', damage: 160, rpm: 28, headshotMult: 1.45, effectiveRange: 70, fireModes: ['single'], damageFalloff: { end: 350, minScale: 1 }, ammoTypes: ['makeshift_batteries', 'accumulators'], stats: { verticalRecoil: 0, horizontalRecoil: 0, hipSpread: 5, adsSpread: 0.01, moveSpeed: -4.00 } },
    // PISTOLS
...
const AMMO_TYPES = [
    ...
    // 12.7x55
    { id: '127x55', name: 'Патроны 12,7x55 мм', nameEn: '12.7x55mm Rounds', caliber: '12.7x55', type: 'standard', price: 19, stats: { armorPenetration: 15 }, pellets: null, description: 'Крупнокалиберные патроны', descriptionEn: 'Large caliber rounds' },
