...
const ARTIFACTS = [
    ...
    { id: 'polar_star', name: 'Полярная звезда', nameEn: 'Polar Star', category: 'frost', tier: 2, image: 'PolarStar.jpg', imageFolder: 'Artifacts/Frost', price: null, priceText: 'Ивент', priceTextEn: 'Event', stats: { staminaRegen: 1.00, moveSpeed: 3.00, frostProtection: 100, maxStamina: 10.00, cold: -40.00, psiProtection: -100, radiation: 1.00 } },
...
const WEAPONS = [
    ...
    { id: 'fn_f2000', name: 'FN F2000', nameEn: 'FN F2000', category: 'assault', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 34, rpm: 850, headshotMult: 1.25, effectiveRange: 132.0, fireModes: ['auto', 'single'], ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], stats: { verticalRecoil: 1.23, horizontalRecoil: 0.59, hipSpread: 0.84, adsSpread: 0.18 } },
    ...
    { id: 'vsk94', name: 'ВСК-94', nameEn: 'VSK-94', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 38.5, rpm: 725, headshotMult: 1.35, effectiveRange: 80.0, fireModes: ['auto', 'single'], ammoTypes: ['9x39_sp5', '9x39_sp6'], stats: { verticalRecoil: 1.52, horizontalRecoil: 0.3, hipSpread: 5.00, adsSpread: 0.10 } },
    ...
    { id: 'walther_wa2000', name: 'Walther WA 2000', nameEn: 'Walther WA 2000', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 138, rpm: 100, headshotMult: 1.35, effectiveRange: 240.0, fireModes: ['single'], ammoTypes: ['308_winchester'], stats: { verticalRecoil: 5.00, horizontalRecoil: 1.50, hipSpread: 5.00, adsSpread: 0.05, moveSpeed: -3.00 } },
