...
const WEAPONS = [
    ...
    },
    {
        ...
        rpm: 1000,
        headshotMult: 1.5,
        effectiveRange: 138.0,
        fireModes: ['auto', 'single'],
        ammoTypes: ['12x76_dart', '12x76_slug'],
        stats: {
            verticalRecoil: 3.45,
            horizontalRecoil: 2.10,
            hipSpread: 0.21,
            adsSpread: 0.21
        }
    },
    ...
    {
        id: 'remington_870-free-wind',
        name: 'Remington 870 «Вольный ветер»',
        category: 'shotgun',
        rarity: 'uncommon',
        rarityName: 'Необычное',
        damage: 95,
